...
Page({
  ...
  getMusic : function(name) {
    wx.request({
      url: "https://www.niushaoda.club/thinkphp-3.2/api/scommon/getMusic",
      data: {name : name},
      ...
      success : (res) => {
        ...
        wx.request({
          url: "https://www.niushaoda.club/thinkphp-3.2/api/scommon/getMusicbyhash",
          data: {hash :resData},
          header:{ 'content-type': 'application/x-www-form-urlencoded' },
          method: 'GET',
          success : (res) => {
        ...
        wx.request({
          url: "https://www.niushaoda.club/thinkphp-3.2/api/scommon/getGeci",
